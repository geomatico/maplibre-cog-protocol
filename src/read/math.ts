...
const GEOGRAPHIC_EXTENT = 360; // degrees (full longitude range, for EPSG:4326)
...
// For EPSG:4326 GeoTIFFs where getResolution() returns degrees/pixel
export const zoomFromResolutionGeographic = (res: number): number =>
  Math.log2(GEOGRAPHIC_EXTENT / (TILE_SIZE * res));
